...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "How to query data:\n"
    "- ALWAYS use query_metrics (the semantic layer) first. Choose the semantic model from the "
    ...
    "- To compare across models (e.g. portfolio vs benchmarks), call query_metrics once per "
    ...
    "(convert query_metrics rows into objects keyed by column name). "
